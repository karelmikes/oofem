...
#ifndef qcnonlinearstatic_h
#define qcnonlinearstatic_h
...
#define _IFT_QcNonLinearStatic_Name "qcnonlinearstatic"
 ...
 * - Managing time steps.
 */
 class QcNonLinearStatic : public NonLinearStatic
{
protected:
...
public:
    QcNonLinearStatic(int i, EngngModel *master = nullptr);
    virtual ~QcNonLinearStatic();
    ...
    // identification
    const char *giveInputRecordName() const override { return _IFT_QcNonLinearStatic_Name; }
    const char *giveClassName() const override { return "QcNonLinearStatic"; }
