...
namespace oofem {
REGISTER_EngngModel(QcNonLinearStatic);

QcNonLinearStatic :: QcNonLinearStatic(int i, EngngModel *_master) : NonLinearStatic(i, _master), loadVector(), displacementVector()
{
}


QcNonLinearStatic :: ~QcNonLinearStatic()
{
}
...
void QcNonLinearStatic :: solveYourself()
{
    NonLinearStatic :: solveYourself();
}


void QcNonLinearStatic :: solveYourselfAt(TimeStep *tStep)
{
...
void
QcNonLinearStatic :: initializeFullSolvedDomain(InputRecord &ir)
{
...
bool
QcNonLinearStatic :: nodeInFullSolvedDomainTest(Node *n)
{
...
void
QcNonLinearStatic :: setRepNodesInVerticesOfInterpolationMesh(Domain *d)
{
...
void
QcNonLinearStatic :: setQCNodeType(Domain *d)
{
...
void
QcNonLinearStatic :: updateNodeTypes(Domain *d)
{
    for ( int i = 1; i <= d->giveNumberOfDofManagers(); i++ ) {
        //   for ( Dof *dof: *this ) {
        //for ( qcNode *n: *this ) {
...
void
QcNonLinearStatic :: createInterpolationMeshNodes(Domain *d)
{
    // interpolation mesh
    if ( generateInterpolationElements == 0 ) {
...
std :: vector< IntArray >
QcNonLinearStatic :: generateInterpolationMesh(Domain *d)
{
...
std :: vector< IntArray >
QcNonLinearStatic :: loadInterpolationMesh(Domain *d)
{
    std :: vector< IntArray >newMeshNodes;
    //#ifdef __T3D
    T3DInterface t3dInterface( this->giveDomain(1) );
...
std :: vector< IntArray >
QcNonLinearStatic :: transformMeshToParticles(Domain *d, std :: vector< FloatArray > &nodeCoords, std :: vector< IntArray > &meshNodes)
...
double
QcNonLinearStatic :: computeTotalVolumeOfInterpolationMesh(Domain *d)
...
DofManager *
QcNonLinearStatic :: findNearestParticle(Domain *d, FloatArray coords)
{
...
QCFullsolveddomain *
QcNonLinearStatic :: giveFullSolvedDomain()
{
...
void
QcNonLinearStatic :: setActivatedNodeList(IntArray nodeList, Domain *d)
{
...
void
QcNonLinearStatic :: setActivatedElementList(IntArray elemList)
{
